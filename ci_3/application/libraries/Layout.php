...
/**
	 ...
	 */	
	public $title       = '..:: Tamila ::..';	
	public $keywords    = 'marketing digital, páginas web, tiendas virtuales, seguridad informática, cursos de capacitación, charlas, diseño web, internet, blog';	
    public $name       = 'Agencia Tamila Digital';
	public $descripcion = 'Somos una agencia que se dedica a convertir ideas en proyectos digitales."';
